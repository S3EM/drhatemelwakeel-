        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 opacity-100 transition-opacity">
          ...
          <div className="relative bg-white rounded-[32px] shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col animate-in fade-in zoom-in duration-300" dir="rtl">
            ...
            <div className="overflow-y-auto w-full h-full">
              {/* Modal Header */}
              <div className="w-full h-[300px] sm:h-[450px] relative bg-[#111] flex flex-col items-center justify-center overflow-hidden">
                <SafeImage 
                  src={selectedArticle.image} 
                  alt={selectedArticle.title} 
                  className="w-full h-full object-contain sm:object-cover" 
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#111] via-[#111]/40 sm:via-black/40 to-transparent flex items-end">
                   <h3 className="font-bold text-2xl sm:text-5xl text-white leading-tight relative p-5 sm:p-10 w-full drop-shadow-md">
